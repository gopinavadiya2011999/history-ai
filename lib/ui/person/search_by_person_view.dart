...
import 'package:history_ai/ui/person/sub_widgets/category_list_with_person.dart';

class SearchByPersonView extends GetView<SearchByPersonController> {
  const SearchByPersonView({super.key});
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Expanded(
                      child: controller.isLoading.value && controller.categoryList.isEmpty
                          ? const Center(
