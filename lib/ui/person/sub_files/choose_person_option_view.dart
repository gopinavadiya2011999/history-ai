...
class ChoosePersonOptionView extends StatelessWidget {
  const ChoosePersonOptionView({super.key});
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        CommonBtnContainer(
                          onTap: () {
                            controller.isHistorySelected.value = true;
                            controller.update();
                            Get.toNamed(RouteConstants.searchByPersonScreen);
                          },
                          title: AppConstants.historicalChat.tr,
